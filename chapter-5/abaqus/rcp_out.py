...
#
#		Reads an ABAQUS output (.odb) database and calculates the radial collapse 
# 		pressure of parametric stent geometries
#
#		Author: Ross Blair
# 		Date:	18/02/17
#
...
RCP = (RFSUM10/surfaceAreaOuter*10**6)/8
#
# ********************************************************************************
# Output
# ********************************************************************************
#
# Write to text file
paramsFile = open('output_rcp.txt','w')
paramsFile.write(str(RCP))
paramsFile.close()
odb.close()
#
# ********************************************************************************